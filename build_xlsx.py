...
log = [
    ...
    ["25.05.2026 (Sebastians Folge)", "Dani (Castelo de Vide)", "Telegram DM",
     ...
     "⏳ Zu senden",
     "Smart strategisch: Material-Wahl Dani uebergeben (sie kennt ESVO besser), Verantwortung Verarbeitung bei Dani. Direkte ESVO-Links als Verifikation. Demuetiger 'Wartungs-Aufwand'-Teil rausgenommen - klare offensive Botschaft."],
