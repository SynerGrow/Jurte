...
rows7 = [
    ...
    ["Mikael (Mickaël) - Telegram-Gruppe Yurts PT (Gouveia/Guarda)",
     ...
     "15.000 EUR + Versand", "NEU (sofort lieferbar)",
     "HOLZWAND-Style (vertikale Bretter, NICHT traditionelle Khaana - sieht nach Pacific-Yurts-aehnlicher Bauart aus). Canvas-Dach Standard + EXTRA VINYL-OVERLAY-OPTION (Vinyl-Dach hat 2 zusaetzliche Oeffnungen, braucht 2 zusaetzliche Fenster). AC4-LAMINAT-FLOORING INKLUSIVE. Empfiehlt Sommer-Schattennetz.",
     "Versand NICHT in 15k - separat. Standort Gouveia 400 km von Aljezur. Vermutlich 800-1.500 EUR.",
     "Telegram Direkt-Kontakt 'Mickaël' (Gruppe Jurten Portugal)",
     "VERDACHT: VERBUNDEN MIT BENEDIKT 'YURY' (selber Standort Gouveia, selber Preis 15k, selbe Groesse 8m). Sebastian fragt direkt nach. PROS: Holzwand stabiler+windfester als Khaana, AC4-Boden im Preis. CONS: Vinyl heizt in Algarve auf, Canvas nur 3-5 J. Lebensdauer, kein Hinweis auf Hersteller/Garantie. Mikael spricht englisch+franzoesisch."],
