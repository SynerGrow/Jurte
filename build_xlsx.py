...
log = [
    ...
    ["~29.05.2026 (Sebastians Folge)", "Mikael (Bento)", "Telegram DM",
     ...
     "⏳ Zu senden",
     "Drei mögliche Reaktionen: a) Ok nach Besuch = ideal, Sebastian hat 3 Wochen Bedenkzeit. b) Kompromiss 2k jetzt + Rest spaeter = 10% Reservierung. c) Ultimatum 'jetzt oder weg' = Sebastian muss blind entscheiden oder Mikael loslassen."],
