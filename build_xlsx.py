...
rows1 = [
    ...
    ["Bet Yurts (Algarve - Nadav & Noga)", "Portugal (Algarve)", "https://www.betyurts.com/",
     "5/6/7/8/9 m Durchmesser",
     "Basispreise auf https://www.betyurts.com/pricing (als Bild) - Aufpreis 800 EUR pro zusaetzlicher Oeffnung bestaetigt",
     "Gitterwand Nordische Kiefer (Wandhoehe 2,20 m), Innenwand 100% Baumwolle, Daemmung 8 cm recyceltes PET-Vlies, Aussenplane Acryl MARINE-GRADE UV-/schimmelfest mit PVC-Schuerze, Plexikuppel oeffenbar, Silikon-Kaminmanschette Standard, Glastuer Zedernholz-Rahmen doppelverglast",
     "SEHR GUT FUER ALGARVE-KUESTE: Marine-grade UV-Plane (explizit kuestentauglich), PET-Daemmung (schimmel-/feuchteresistenter als Schafwolle in Salzluft), Kronenring 1,20 m / Hoehe 2,90-3,70 m",
     "Inland Algarve - Transport+Aufbau gegen Aufpreis (Distanzabhaengig). Vorgefertigte gedaemmte Plattform mit Erdschrauben + Kiefer-Sperrholzboden im Angebot.",
     "Schreiner Nadav + Produktdesignerin Noga - lebt selbst was sie baut. Standard inkl.: doppelverglaste Glastuer, Plexikuppel, Kaminmanschette. Optionen: 800 EUR/Oeffnung. Kontakt: noga@betyurts.com / +351 961 592 792",
     "Basispreis aus Web nicht extrahierbar (Bild); Anfrage gestellt, Erwartung 12.000-18.000 EUR fuer 7-9m mit Plattform+Aufbau"],
