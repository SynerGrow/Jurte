...
log = [
    ...
    ["~25.05.2026", "Chris (Danis Mann, Castelo de Vide)", "Telegram DM",
     "Sebastian -> Chris",
     "Persoenliche Einleitung + 4 inhaltliche Punkte (von urspruenglicher Dani-Mail): 1) Aufbau wo+Transport, 2) Holz-Behandlung Termiten, 3) Plattform-Masse fuer DIY, 4) Lieferzeit Aug/Sep konkret. PLUS integriert: Schafwoll-Frage (Chris ist Wolle-Quelle laut Dani). Plus Probeschlafen-Termin.",
     "⏳ Zu senden",
     "WICHTIGE KORREKTUR: Chris ist Danis Mann (Partner), nicht externer Anbieter! Sebastian schreibt direkt an ihn als technische Person des Paars. Beide getrennten Mails (Dani 4 Punkte + Chris Schafwoll) in EINE konsolidierte Chris-Mail integriert. Eine Person zu kontaktieren ist effizienter."],
