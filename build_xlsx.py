...
log = [
    ...
    ["25.05.2026 (Sebastians Folge)", "Dani (Castelo de Vide)", "Telegram DM",
     ...
     "⏳ Zu senden",
     "Bei Antwort: konkrete Preise + Empfehlung. Wenn 420 g/m² Variante moeglich: Premium-Setup mit Algarve-tauglichem Material UND atmungsaktivem BW/Poly UND Glamping-Industriestandard. Lebensdauer geschaetzt 10+ Jahre in Algarve."],
