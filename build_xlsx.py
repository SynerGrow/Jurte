...
rows7 = [
    ...
    ["Mikael (Mickaël) = Bento - Pacific Yurts 8m 'European Modern' (Gouveia)",
     "Portugal (Gouveia, Guarda)",
     "8 m, 2.10 m Wandhoehe", "ca. 50 m2",
     "15.000 EUR (Jurte only) + 700 EUR optional AC4 + Versand. PLATTFORM NICHT INKL! DAEMMUNG-NACHRUESTUNG noetig fuer Algarve.",
     "NEU (sofort lieferbar, NIE aufgebaut) - ROSTPROBLEM an Schrauben + KRITISCH DUENNE DAEMMUNG 7mm",
     "HERSTELLER: PACIFIC YURTS USA Modell 'European Modern' (vage Bezeichnung). KONSTRUKTION: TRADITIONELLE KHAANA-SCHEREN-GITTER (maschinen-praezise). Holz: Massiv Nordische Kiefer, klar lackiert OHNE Insektizid. ISOLIERUNG: NUR 7mm Schafwoll-Filz, 1,1 kg/m² Flaechengewicht (= 157 kg/m³ Dichte normal, aber DICKE KRITISCH DUENN fuer Algarve-Winter). R-Wert ~0,18 (Dani 40mm: R~1,0 = 5x besser). Pacific Yurts Standard ist fuer US-West-Klima ausgelegt, nicht Atlantik-Winter. SEBASTIAN MUSS ZUSAETZLICHE 8mm Schafwoll-Filz NACHRUESTEN (~600 EUR Material, von Chris PT). Canvas-Dach Standard + Vinyl-Overlay-Option. SKYLIGHT: 1.40m Kiefer+Eisen. KONFIGURATION: 1 Doppeltuer + 2 Glas-Fenster integriert in Khaana. AC4-LAMINAT-BODEN OPTIONAL 700 EUR fuer 52 m² (Selbstkostenpreis, fair). PLATTFORM NICHT enthalten - Sebastian baut selbst (Empfehlung Mikael: Saegewerk-Holz lokal).",
     "Versand NICHT in 15k - separat (vermutlich 800-1.500). ALGARVE-RISIKO: Termiten obligatorisch (~500 EUR). MAENGEL: Schrauben rostig - Komplett-Ersatz noetig (Edelstahl A4) - ~200 EUR Material + 30 Std Arbeit. ZUSAETZLICHE DAEMMUNG ~600 EUR.",
     "Telegram Direkt-Kontakt 'Mickaël' = Bento (OLX-Verkaeufer)",
     "REZENTE KOSTEN-AKTUALISIERUNG 24.05.2026: KRITISCH dunne Daemmung 7mm = Nachruest-Bedarf. ALL-IN ~22.040 EUR (Pacific Yurts 15k + AC4 700 + Plattform Kork-Premium 3.300 + Zusatz-Daemmung 600 + Versand 1k + Termiten 500 + Schrauben 200 + Schatten 240 + Reserve 500). ~80-100 Std Eigenarbeit. JETZT TEURER ALS DANI 7m (21,6k). VERGLEICH Mikael (50m², Pacific Brand, dünne Daemmung+Rost+Termiten-Risiko, sofort verfuegbar) vs DANI (38m², Community+Probeschlafen+atmungsaktiv+5x bessere Daemmung+anpassbar Sauleda). DANI klar im Vorteil wenn Wohnkomfort > 12m² Mehrflaeche."],
