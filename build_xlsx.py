...
log = [
    ...
    ["~25.05.2026", "Chris (Danis Mann, Castelo de Vide)", "Telegram DM",
     "Sebastian -> Chris",
     "FINAL 4-Punkte-Mail an Chris: 1) AUFBAU - anerkennt Danis Aussage 'inkl. Aufbau', fragt KONKRETISIERUNG: liefert ihr zu mir nach Aljezur+Aufbau vor Ort? Transport extra/inkl? 2) Holz-Behandlung Termiten 3) Plattform-Masse fuer DIY 4) Lieferzeit Aug/Sep + Probeschlafen-Termin. Schafwoll-Frage bewusst NICHT in dieser Mail (kommt spaeter wenn naehere Klaerung).",
     "⏳ Zu senden",
     "Persoenlich+praezise: 'Dani hatte gesagt' zeigt Sebastian geht nicht hinter Dani's Ruecken vorbei. Aufbau-Frage konkretisierend statt offen. 'euch' anerkennt Paar-Team."],
