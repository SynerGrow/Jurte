...
rows1 = [
    ...
    ["Dani + Chris (Castelo de Vide Community-Projekt) - 7m Custom",
...
log = [
    ...
    ["25.05.2026 (Sebastians Folge)", "Dani (Castelo de Vide)", "Telegram DM",
     "Sebastian -> Dani",
     "Begeistert: 'ESVO hat ja Sauleda und andere Marine-Acryl im Programm!' Sebastian schaut bei ESVO konkret. Vorschlag: Premium-Variante ueber Dani's gewohnten ESVO-Weg gehen (sie kennt Bestell-Prozedur, ESVO liefert kostenlos PT). Bittet Dani um EMPFEHLUNG welche ESVO-Marine-Variante fuer Algarve-Wohnjurte. Demuetig: 'falls ihr Sauleda nie genaeht habt, kein Druck - dann ESVO-Standard mit Wartung alle paar Jahre'.",
     "⏳ Zu senden",
     "Smart strategisch: Material-Wahl Dani uebergeben (sie kennt ESVO besser), Verantwortung Verarbeitung bei Dani. ESVO-Sauleda-Links als Verifikation."],
