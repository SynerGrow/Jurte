...
rows4 = [
    ...
    [3, "Paula Young - gebrauchte Casa-Jurte 7,3m",
    ...
    [4, "Yurt Made in Portugal (Loures, OLX-Hersteller)",
    ...
    [6, "Casa dos Sonhos Yurts (2027er Slot)",
