...
rows4 = [
    ...
    [2, "OLX Benedikt 8m 'Yury' (Gouveia, Zentral-PT)",
     "Privatverkauf NEU - 8m Komplett-Setup",
     "15.000 EUR (inkl. Tuer + 2 Fenster + weisser Innenstoff + Filzisolierung + 'Gruendach')",
     "BESTER 8M-PREIS IM MARKT (Mai 2026 entdeckt) - 50 m2 Wohnflaeche fuer 15k all-in. Verkaeufer Benedikt = deutscher Reseller in Gouveia (Serra da Estrela), Inserat auf Deutsch. NEUWARE. Standort 4-5 h von Aljezur. ACHTUNG: Privatverkauf ohne Verbraucherschutz - vor Anzahlung: Besichtigung + Klaerung Plane-UV/Hersteller/Transport/Garantie/'Gruendach'. Modell 'Yury' deutet auf Green World UA Hersteller hin.",
...
rows7 = [
    ...
    ["Mikael (Mickaël) - Telegram-Gruppe Yurts PT (Gouveia/Guarda)",
     "Portugal (Gouveia, Guarda - selber Ort wie Benedikt!)",
     "8 m, 2.10 m Wandhoehe", "ca. 50 m2",
     "15.000 EUR + Versand", "NEU (sofort lieferbar, NIE aufgebaut)",
     "HERSTELLER: PACIFIC YURTS USA (Oregon, seit 1978, Industrie-Standard moderne Jurten). KONSTRUKTION: HOLZWAND-Style (vertikale Bretter, Massiv-Holz Nordische Kiefer, klar lackiert OHNE Insektizid - SEBASTIAN MUSS SELBST GEGEN TERMITEN BEHANDELN!). Canvas-Dach Standard + EXTRA VINYL-OVERLAY-OPTION (Vinyl-Dach hat 2 zusaetzliche Oeffnungen, braucht 2 zusaetzliche Fenster). ISOLIERUNG: Schafwoll-Filz 1.1 kg/m² Dichte - Dicke 0.7mm angegeben (verdaechtig duenn - muss geklaert werden ob 0.7mm Filz oder Canvas oder Schreibfehler 7mm). SKYLIGHT: 1.40 m Kiefer+Eisen. KONFIGURATION: 1 Tuer + 1 Fenster pro Seite = 2 Fenster total. AC4-LAMINAT-FLOORING INKLUSIVE (schwimmend verlegt, Sebastian installiert).",
     "Versand NICHT in 15k - separat. Standort Gouveia 400 km von Aljezur. Vermutlich 800-1.500 EUR. ALGARVE-RISIKO: Termiten-Behandlung obligatorisch (Borax oder professionell ~200-500 EUR + 2 Tage Arbeit).",
     "Telegram Direkt-Kontakt 'Mickaël' (Gruppe Jurten Portugal)",
     "PACIFIC YURTS = PREMIUM-HERSTELLER (Pluspunkt!). ABER 3 KRITISCHE PUNKTE: 1) KEIN Insektizid-Schutz - Algarve-Termiten-Risiko. 2) Filz-Dicke unklar (0.7mm zu duenn fuer Daemmung). 3) Nur 1 Tuer + 2 Fenster vs Danis 2 Doppeltueren. CONNECTION BENEDIKT: Mikael sagt 'kennt ihn nicht' und will OLX-Link sehen - vermutlich genuin separate Verkaeufer, Pacific-Yurts-Hersteller-Naehe ist Indiz dass Benedikt evtl. anderes Modell hat."],
