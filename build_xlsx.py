...
rows7 = [
    ...
    ["Mikael (Mickaël) = Bento - Pacific Yurts 8m 'European Modern' (Gouveia)",
     ...
     "15.000 EUR + Versand (MAENGELPREIS wegen Rost an Khaana-Schrauben)",
     "NEU (sofort lieferbar, NIE aufgebaut) - aber ROSTPROBLEM an Schrauben",
     "HERSTELLER: PACIFIC YURTS USA Modell 'European Modern' (vage Bezeichnung). KONSTRUKTION: TRADITIONELLE KHAANA-SCHEREN-GITTER (maschinen-praezise). Holz: Massiv Nordische Kiefer, klar lackiert OHNE Insektizid - SEBASTIAN MUSS TERMITEN BEHANDELN. ISOLIERUNG: Schafwoll-Filz 7mm (KORRIGIERT - traditioneller Standard, OK) Dichte 1.1 kg/m². Canvas-Dach Standard + Vinyl-Overlay-Option. SKYLIGHT: 1.40m Kiefer+Eisen. KONFIGURATION: 1 Doppeltuer + 2 Glas-Fenster integriert in Khaana. AC4-LAMINAT-FLOORING INKLUSIVE. PLATTFORM AUFGESTAENDERT sichtbar.",
     "Versand NICHT in 15k - separat (vermutlich 800-1.500). ALGARVE-RISIKO: Termiten obligatorisch (~500 EUR). MAENGEL: Schrauben rostig - Komplett-Ersatz noetig (Edelstahl A4) - ~200 EUR Material + 30 Std Arbeit Selbstaufbau.",
     "Telegram Direkt-Kontakt 'Mickaël' = Bento (OLX-Verkaeufer - Uebersetzer-Fehler hatte 'Benedikt' gemacht).",
     "GAME-CHANGER UPDATE 24.05.2026: Mikael IST der OLX-Verkaeufer (Bento - Uebersetzer-Verwirrung). Mikael ehrlich ueber Maengel (Rost) - das spricht fuer Vertrauen. Filz 7mm bestaetigt (OK). Modell-Name vage. ALL-IN ~17.440 EUR (mit Schrauben-Ersatz 200 + Termiten 500 + Versand 1000 + Schatten 240 + Reserve 500) - PLUS 30 Std Eigenarbeit Schrauben-Tausch. WICHTIG: vor Anzahlung Rost-Ausmass vor Ort pruefen + Pacific-Yurts-Modell-Name + Sunforger-Canvas-Spec klaeren."],
