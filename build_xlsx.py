...
log = [
    ...
    ["25.05.2026 (Sebastians smarte Folge)", "Dani (Castelo de Vide)", "Telegram DM",
     ...
     "⏳ Zu senden",
     "Smart: zeigt Sebastian denkt selber mit. 3 moegliche Reaktionen: a) 'Mit Schattennetz reicht leichter' = spart 700+ EUR, b) 'In Algarve trotzdem schwer' = Erfahrung folgen, c) 'Kommt auf Standort an' = situationsbezogene Empfehlung."],
    ["~26.05.2026", "Mikael (Bento)", "Telegram DM", "Sebastian -> Mikael",
     ...
     "⏳ Zu senden",
     "STRATEGISCHE LAGE: Dani gewinnt gerade Boden mit Campshield-Loesung. Mikael ist Plan B. Sebastian haelt ihn nicht hin sondern gibt ehrliche Frage zurueck. 3 moegliche Reaktionen: a) Ja Etappenzahlung = Luxus-Problem zwei Optionen, b) Nein brauche Geld = klare Absage moeglich, c) Schon verkauft = Karten gespielt."],
