...
rows7 = [
    ...
    ["Mikael (Mickaël) = Bento - Pacific Yurts 8m 'European Modern' (Gouveia)",
     ...
     "15.000 EUR (Jurte only) + 700 EUR optional AC4 + 750 EUR Selbst-Abholung Van. PLATTFORM NICHT INKL!",
     "NEU - August 2025 gekauft Pacific Yurts, BIG FIRE zerstoerte ihre Plaene, seitdem in einem Van gelagert (10 Mon). ROSTPROBLEM an Khaana-Schrauben (vermutlich Van-Lagerung+Feuchte). NIE aufgebaut.",
     "HERSTELLER: PACIFIC YURTS USA Modell 'European Modern' (Aug 2025 gekauft, also 2025er Spec). KONSTRUKTION: TRADITIONELLE KHAANA-SCHEREN-GITTER. Holz: Massiv Nordische Kiefer, klar lackiert OHNE Insektizid. ISOLIERUNG: 7mm Schafwoll-Filz, 1,1 kg/m² Flaechengewicht (= 157 kg/m³ Dichte normal, aber DICKE KRITISCH DUENN fuer Algarve). R-Wert ~0,18 (Dani 40mm R~1,0 = 5x besser). Pacific Yurts Standard fuer US-West-Klima. Sebastian muss zusaetzliche 8mm Schafwoll-Filz NACHRUESTEN (+600 EUR). Canvas-Dach Standard + Vinyl-Overlay-Option. SKYLIGHT: 1.40m Kiefer+Eisen. KONFIGURATION: 1 Doppeltuer + 2 Glas-Fenster integriert. AC4-LAMINAT-BODEN OPTIONAL 700 EUR fuer 52 m². PLATTFORM NICHT enthalten - Sebastian baut selbst.",
     "VERSAND BESTAETIGT: 750 EUR Selbst-Abholung mit gemietetem Van (Real-Referenz von anderem Kunden in Sebastians Naehe). Spedition vermutlich 1k-1.5k. ALGARVE-RISIKO: Termiten obligatorisch (+500), Schrauben-Ersatz Edelstahl A4 (+200 + 30 Std), Zusatz-Daemmung 8mm (+600 + 5 Std).",
     "Telegram Direkt-Kontakt 'Mickaël' = Bento (OLX-Verkaeufer). Tragische Geschichte: Brand-Opfer.",
     "AKTUALISIERTE KOSTEN 24.05.2026 mit echtem Versand 750: ALL-IN ~21.790 EUR (Pacific Yurts 15k + AC4 700 + Plattform Kork 3.300 + Zusatz-Daemmung 600 + Versand Selbst-Abholung 750 + Termiten 500 + Schrauben 200 + Schatten 240 + Reserve 500). PRAKTISCH GLEICH MIT DANI (21,6k). VERGLEICH bleibt: Mikael 50m² Pacific-Brand aber 7mm Daemmung+Rost+Termiten+10Mon-Van-Lagerung-Risiko vs DANI 38m² mit 40mm Daemmung+Community+Probeschlafen+anpassbar Sauleda."],
