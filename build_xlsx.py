...
rows4 = [
    # NEU sortiert nach Casa-Slot-Verlust 15.05.2026
    [1, "DIY Modify Szenario A (Adorjan-Rahmen + Algarve-Sauleda-Sattler)",
    ...
    [2, "Paula Young - gebrauchte Casa-Jurte 7,3m",
    ...
    [3, "Yurt Made in Portugal (Loures, OLX-Hersteller)",
    ...
    [5, "Casa dos Sonhos Yurts (2027er Slot)",
