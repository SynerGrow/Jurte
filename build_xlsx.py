...
log = [
    ...
    ["24.05.2026 (Sebastians ehrliche Folge)", "Mikael (Bento)", "Telegram DM",
     "Sebastian -> Mikael",
     "EHRLICHE CASHFLOW-NACHRICHT: Sebastian hat 5k sofort, kann Rest 16k ueber 3 Monate aufbringen. Vorschlag: 5k jetzt Anzahlung + 5k 15.06 + 5k 15.07 + 6k 15.08 = 21k total. Pickup erst nach Vollzahlung (Sicherheit fuer Mikael). Respektvoll: 'wenn das nicht geht weil du Geld schneller brauchst, kein Problem, dann warte ich bis ich mehr gespart habe'.",
     "⏳ Zu senden",
     "DREI MOEGLICHE REAKTIONEN: A) Mikael sagt JA = Deal mit Ratenzahlung. B) Mikael verhandelt = Mittelweg suchen. C) Mikael sagt NEIN = respektvoll Plan B (Dani Custom-Bau)"],
