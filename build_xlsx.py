...
log = [
    ...
    ["~25.05.2026 (Sebastians naechste Mail)", "Dani (Castelo de Vide)", "Telegram DM",
     ...
     "⏳ Zu senden",
     "Strategisch: erst inhaltliche Fragen + Vertrauen, dann separat Geld-Thema (Anzahlung+Etappen). Sebastian-Style: 'erst die Sache, dann das Geld'."],
    ["~25.05.2026", "Chris (PT-Schafwoll-Anbieter via Dani)", "Telegram DM",
     "Sebastian -> Chris",
     "Erstanfrage Deutsch: Selbst-Vorstellung + Dani's Vermittlung als Referenz. Bedarf: 50-60 m² Schafwoll-Filz (8mm/16mm) fuer Algarve-Atlantikkueste. Fragen: Preis pro m², Lieferung 8650 Aljezur, Lieferzeit, Mengenrabatt, Motten-/Insekten-Behandlung, Algarve-Referenzkunden.",
     "⏳ Zu senden",
     "Bei Antwort: Vergleich mit Isolena AT und Tobias Tumfart AT. Chris als lokale PT-Quelle koennte Versand-Vorteil haben."],
