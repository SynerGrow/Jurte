...
rows1 = [
    ...
    ["Dani's Community-Projekt 7m Custom (Castelo de Vide, Alentejo)",
     ...
     "16.000 EUR inkl. Aufbau (Transport+Plattform extra). UPGRADES MOEGLICH: Sauleda-Plane +1.100 EUR Material, 8cm Wolle +400 EUR Material",
     ...
     "TOP-EMPFEHLUNG WENN UPGRADES MACHBAR: Dani 16k + Sauleda-Upgrade 1.100 + 8cm-Wolle 400 + Plattform Kork 2.880 + Transport 1.000 + Schattennetz 240 = ~21.620 EUR all-in. Spar gegenueber Canvas-5J-Tausch ueber 10J ca. 1.200 EUR. PLUS: 4 Familien-Community vor Ort fuer Sebastians Familie sehr willkommen."],
]
